 ...
 *
 * Disassembly of 1500, Sat Aug  2 09:00:07 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000050DE (20702)
 ...
 */
DefinitionBlock ("1500.aml", "DSDT", 1, "VIA  ", "PTL_ACPI", 0x06040000)
{
    Scope (\)
    {
        Name (PICF, 0x00)
    ...
    Scope (\_SB)
    {
        ...
        OperationRegion (PSCB, SystemMemory, 0x1FEFBEBD, 0x00000090)
    ...
    {
        Name (OSTB, Ones)
        OperationRegion (OSTY, SystemMemory, 0x1FEFBEBC, 0x00000001)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (SGIO, SystemIO, 0x0609, 0x01)
                ...
                Device (FDC)
                {
                    ...
                    OperationRegion (FDMM, SystemMemory, 0x048B, 0x01)
                    Field (FDMM, ByteAcc, NoLock, Preserve)
                    {
                            ,   2, 
                        FDCD,   6
                    }

                    OperationRegion (FDIO, SystemIO, 0x03F3, 0x01)
                    Field (FDIO, ByteAcc, NoLock, Preserve)
                    {
                            ,   2, 
                        FDTP,   2, 
                                Offset (0x01)
                    ...
                    Method (_CRS, 0, NotSerialized)
                    {
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.FDC._Y16._MIN, MINA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.FDC._Y16._MAX, MAXA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.FDC._Y17._MIN, MINB)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.FDC._Y17._MAX, MAXB)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.FDC._Y18._INT, INTA)
                        CreateByteField (CRSA, \_SB.PCI0.LPCB.FDC._Y19._DMA, DMAB)
                        If (REGR (0x00, 0x30))
                        {
                            Store (_PRS, CRSA)
                        }
                ...
                Device (LPT)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)
                    {
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.LPT._Y1A._MIN, MINA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.LPT._Y1A._MAX, MAXA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.LPT._Y1B._INT, INTA)
                        CreateByteField (CRSA, \_SB.PCI0.LPCB.LPT._Y1A._LEN, LENA)
                        Store (Zero, MINA)
                        Store (Zero, MAXA)
                        Store (Zero, INTA)
                        Store (Zero, LENA)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y1C._MIN, MINB)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y1C._MAX, MAXB)
                        CreateByteField (CRSB, \_SB.PCI0.LPCB.LPT._Y1C._LEN, LENB)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y1D._MIN, MINC)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y1D._MAX, MAXC)
                        CreateByteField (CRSB, \_SB.PCI0.LPCB.LPT._Y1D._LEN, LENC)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y1E._INT, INTB)
                        CreateByteField (CRSB, \_SB.PCI0.LPCB.LPT._Y1F._DMA, DMAB)
                        Store (Zero, MINB)
                        Store (Zero, MAXB)
                        Store (Zero, LENB)
                        Store (Zero, MINC)
                ...
                Device (COMB)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)
                    {
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.COMB._Y20._MIN, MINA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.COMB._Y20._MAX, MAXA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.COMB._Y21._INT, INTA)
                        Store (Zero, MINA)
                        Store (Zero, MAXA)
                        Store (Zero, INTA)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.COMB._Y22._MIN, MINB)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.COMB._Y22._MAX, MAXB)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.COMB._Y23._INT, INTB)
                        CreateByteField (CRSB, \_SB.PCI0.LPCB.COMB._Y24._DMA, DMAB)
                        Store (Zero, MINB)
                        Store (Zero, MAXB)
                        Store (Zero, INTB)
                        Store (Zero, DMAB)
                ...
                Device (CRDC)
                {
                    ...
                    OperationRegion (WB01, SystemIO, 0x4E, 0x02)
                    Field (WB01, ByteAcc, NoLock, Preserve)
                    {
                        INDX,   8, 
                        DATA,   8
                    }
        ...
        Device (AC)
        {
            ...
            {
                Store (\_SB.PCI0.LPCB.EC.COMD (0xC5, 0x19), Local0)
        ...
        Device (BAT0)
        {
            ...
            Method (UPBI, 0, NotSerialized)
            {
                ...
                If (LEqual (Local5, 0x18))
                {
                    ...
                    Store (0x0188, Index (PBIF, 0x05))
                    Store (0x75, Index (PBIF, 0x06))
                    Store (0x0113, Index (PBIF, 0x07))
                    Store (0x0EDB, Index (PBIF, 0x08))
            ...
            Method (UPBS, 0, NotSerialized)
            {
                ...
                {
                    If (LGreaterEqual (Local0, 0x59))
                    {
                        Store (\_SB.PCI0.LPCB.SIOG, Local3)
