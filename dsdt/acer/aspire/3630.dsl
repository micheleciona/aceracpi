 ...
 *
 * Disassembly of 3630, Fri Oct 17 19:26:21 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000388F (14479)
 ...
 */
DefinitionBlock ("3630.aml", "DSDT", 1, "PTLTD ", "661MX", 0x06040000)
{
    External (Z004)
    ...
    {
        Name (OSTB, Ones)
        OperationRegion (OSTY, SystemMemory, 0x3DDFAE2C, 0x00000001)
    ...
    Scope (_PR)
    {
        ...
        Processor (CPU1, 0x01, 0x00008000, 0x00) {}
    }
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            OperationRegion (OPS0, PCI_Config, 0x70, 0x04)
            ...
            OperationRegion (MA, PCI_Config, 0xAE, 0x02)
            ...
            {
                CreateBitField (CRES, \_SB.PCI0._Y00._RW, C0RW)
                CreateDWordField (CRES, \_SB.PCI0._Y00._LEN, C0LN)
                Store (One, C0RW)
                Store (0x4000, C0LN)
                If (And (\_SB.PCI0.FR70, 0x01))
                {
                    Store (0x00, C0LN)
                }

                CreateBitField (CRES, \_SB.PCI0._Y01._RW, C4RW)
                CreateDWordField (CRES, \_SB.PCI0._Y01._LEN, C4LN)
                Store (One, C4RW)
                Store (0x4000, C4LN)
                If (And (\_SB.PCI0.FR70, 0x02))
                {
                    Store (0x00, C4LN)
                }

                CreateBitField (CRES, \_SB.PCI0._Y02._RW, C8RW)
                CreateDWordField (CRES, \_SB.PCI0._Y02._LEN, C8LN)
                Store (One, C8RW)
                Store (0x4000, C8LN)
                If (And (\_SB.PCI0.FR70, 0x04))
                {
                    Store (0x00, C8LN)
                }

                CreateBitField (CRES, \_SB.PCI0._Y03._RW, CCRW)
                CreateDWordField (CRES, \_SB.PCI0._Y03._LEN, CCLN)
                Store (One, CCRW)
                Store (0x4000, CCLN)
                If (And (\_SB.PCI0.FR70, 0x08))
                {
                    Store (0x00, CCLN)
                }

                CreateBitField (CRES, \_SB.PCI0._Y04._RW, D0RW)
                CreateDWordField (CRES, \_SB.PCI0._Y04._LEN, D0LN)
                Store (One, D0RW)
                Store (0x4000, D0LN)
                If (And (\_SB.PCI0.FR70, 0x10))
                {
                    Store (0x00, D0LN)
                }

                CreateBitField (CRES, \_SB.PCI0._Y05._RW, D4RW)
                CreateDWordField (CRES, \_SB.PCI0._Y01._LEN, D4LN)
                Store (One, D4RW)
                Store (0x4000, D4LN)
                If (And (\_SB.PCI0.FR70, 0x20))
                {
                    Store (0x00, D4LN)
                }

                CreateBitField (CRES, \_SB.PCI0._Y06._RW, D8RW)
                CreateDWordField (CRES, \_SB.PCI0._Y06._LEN, D8LN)
                Store (One, D8RW)
                Store (0x4000, D8LN)
                If (And (\_SB.PCI0.FR70, 0x40))
                {
                    Store (0x00, D8LN)
                }

                CreateBitField (CRES, \_SB.PCI0._Y07._RW, DCRW)
                CreateDWordField (CRES, \_SB.PCI0._Y07._LEN, DCLN)
                Store (One, DCRW)
                Store (0x4000, DCLN)
                If (And (\_SB.PCI0.FR70, 0x80))
                {
                    Store (0x00, DCLN)
                }

                CreateBitField (CRES, \_SB.PCI0._Y08._RW, E0RW)
                CreateDWordField (CRES, \_SB.PCI0._Y08._LEN, E0LN)
                Store (One, E0RW)
                Store (0x4000, E0LN)
                If (And (\_SB.PCI0.FR71, 0x01))
                {
                    Store (0x00, E0LN)
                }

                CreateBitField (CRES, \_SB.PCI0._Y09._RW, E4RW)
                CreateDWordField (CRES, \_SB.PCI0._Y09._LEN, E4LN)
                Store (One, E4RW)
                Store (0x4000, E4LN)
                If (And (\_SB.PCI0.FR71, 0x02))
                {
                    Store (0x00, E4LN)
                }

                CreateBitField (CRES, \_SB.PCI0._Y0A._RW, E8RW)
                CreateDWordField (CRES, \_SB.PCI0._Y0A._LEN, E8LN)
                Store (One, E8RW)
                Store (0x4000, E8LN)
                If (And (\_SB.PCI0.FR71, 0x04))
                {
                    Store (0x00, E8LN)
                }

                CreateBitField (CRES, \_SB.PCI0._Y0B._RW, ECRW)
                CreateDWordField (CRES, \_SB.PCI0._Y0B._LEN, ECLN)
                Store (One, ECRW)
                Store (0x4000, ECLN)
                If (And (\_SB.PCI0.FR71, 0x80))
                {
                    Store (0x00, ECLN)
                }

                CreateDWordField (CRES, \_SB.PCI0._Y0C._MIN, RAMT)
                CreateDWordField (CRES, \_SB.PCI0._Y0C._LEN, RAMR)
            ...
            Device (LPCB)
            {
                ...
                Device (SYSR)
                {
                    ...
                    {
                        CreateWordField (RSRC, \_SB.PCI0.LPCB.SYSR._Y0D._MIN, PMMN)
                        CreateWordField (RSRC, \_SB.PCI0.LPCB.SYSR._Y0D._MAX, PMMX)
                        And (\_SB.PCI0.LPCB.Z000, 0xFF80, PMMN)
                        Store (PMMN, PMMX)
                        Return (RSRC)
                    }
                }
            ...
            Device (LNKA)
            {
                ...
                Method (_CRS, 0, NotSerialized)
                {
                    ...
                    CreateWordField (RSRC, \_SB.PCI0.LNKA._CRS._Y0E._INT, IRQ0)
            ...
            Device (LNKB)
            {
                ...
                Method (_CRS, 0, NotSerialized)
                {
                    CreateWordField (RSRC, \_SB.PCI0.LNKB._Y0F._INT, IRQ0)
            ...
            Device (LNKC)
            {
                ...
                Method (_CRS, 0, NotSerialized)
                {
                    CreateWordField (RSRC, \_SB.PCI0.LNKC._Y10._INT, IRQ0)
            ...
            Device (LNKD)
            {
                ...
                Method (_CRS, 0, NotSerialized)
                {
                    CreateWordField (RSRC, \_SB.PCI0.LNKD._Y11._INT, IRQ0)
            ...
            Device (LNKE)
            {
                ...
                Method (_CRS, 0, NotSerialized)
                {
                    ...
                    CreateWordField (RSRC, \_SB.PCI0.LNKE._CRS._Y12._INT, IRQ0)
            ...
            Device (LNKF)
            {
                ...
                Method (_CRS, 0, NotSerialized)
                {
                    CreateWordField (RSRC, \_SB.PCI0.LNKF._Y13._INT, IRQ0)
            ...
            Device (LNKG)
            {
                ...
                Method (_CRS, 0, NotSerialized)
                {
                    CreateWordField (RSRC, \_SB.PCI0.LNKG._Y14._INT, IRQ0)
            ...
            Device (LNKH)
            {
                ...
                Method (_CRS, 0, NotSerialized)
                {
                    CreateWordField (RSRC, \_SB.PCI0.LNKH._Y15._INT, IRQ0)
        ...
        OperationRegion (SMI1, SystemMemory, 0x3DDFAE2D, 0x00000120)
                                                    ...
                                                    Else
                                                    {
                                                        ...
                                                        Else
                                                        {
                                                            ...
                                                            Else
                                                            {
                                                                ...
                                                                {
                                                                    Store ("BODEN33", Index (PBIF, 0x09))
                                                                }
                                                                Else
                                                                {
                                                                    If (LEqual (Local3, 0x0E))
                                                                    {
                                                                        Store ("BODEN72", Index (PBIF, 0x09))
                                                                    }
                                                                }
                                                            }
                                                        }
