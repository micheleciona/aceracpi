 ...
 *
 * Disassembly of 1640, Fri Dec 14 13:59:59 2007
 *
 *
 ...
 */
DefinitionBlock ("1640.aml", "DSDT", 1, "INTEL ", "ALVISO  ", 0x06040000)
{
    External (Z00A)
    External (PDC1)
    External (PDC0)
    ...
    OperationRegion (MNVS, SystemMemory, 0x7F68AD2C, 0x0100)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (GFX0)
            {
                ...
                OperationRegion (VNVS, SystemMemory, 0x7F68AE2C, 0x00010000)
        ...
        OperationRegion (SMI1, SystemMemory, 0x7F69AE2D, 0x00000120)
