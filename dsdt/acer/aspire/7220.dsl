 ...
 *
 * Disassembly of 7220, Thu Sep 11 22:42:22 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00006996 (27030)
 ...
 */
DefinitionBlock ("7220.aml", "DSDT", 1, "NVIDIA", "MCP67", 0x06040000)
{
    External (\_SB_.PCI0.XVR0.Z00P.MXMS, IntObj)
    External (\_SB_.PCI0.XVR0.Z00P.MXMI, IntObj)
    External (\_SB_.PCI0.XVR0.Z00P.HDV0.MXMX, IntObj)
    External (\_SB_.PCI0.XVR0.Z00P.LCD0.MXMX, IntObj)
    External (\_SB_.PCI0.XVR0.Z00P.CRT0.MXMX, IntObj)
            ...
            Device (WMI1)
            {
                ...
                Method (WMMX, 3, NotSerialized)
                {
                    If (LGreaterEqual (SizeOf (Arg2), 0x04))
                    {
                        ...
                        If (LEqual (FUNC, "MXMI"))
                        {
                            Return (\_SB.PCI0.XVR0.Z00P.MXMI)
                            ARGS
                        }
                        Else
                        {
                            If (LEqual (FUNC, "MXMS"))
                            {
                                Return (\_SB.PCI0.XVR0.Z00P.MXMS)
                                ARGS
                            }
                            Else
                            {
                                If (LGreaterEqual (SizeOf (Arg2), 0x08))
                                {
                                    ...
                                    If (LEqual (FUNC, "MXMX"))
                                    {
                                        ...
                                        {
                                            Return (\_SB.PCI0.XVR0.Z00P.CRT0.MXMX)
                                            SARG
                                        }
                                        Else
                                        {
                                            ...
                                            {
                                                Return (\_SB.PCI0.XVR0.Z00P.LCD0.MXMX)
                                                SARG
                                            }
                                            Else
                                            {
                                                ...
                                                {
                                                    Return (\_SB.PCI0.XVR0.Z00P.HDV0.MXMX)
                                                    SARG
                                                }
                                            }
                                        }
