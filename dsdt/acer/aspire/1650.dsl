 ...
 *
 * Disassembly of 1650, Sun Sep  7 16:41:01 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000566A (22122)
 ...
 */
DefinitionBlock ("1650.aml", "DSDT", 1, "INTEL ", "ALVISO  ", 0x06040000)
{
    External (Z00A)
    External (PDC1)
    External (PDC0)
    ...
    OperationRegion (MNVS, SystemMemory, 0x3FE8BD2C, 0x0100)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (GFX0)
            {
                ...
                OperationRegion (VNVS, SystemMemory, 0x3FE8BE2C, 0x00010000)
        ...
        Device (BAT1)
        {
            ...
            Method (UBIF, 0, NotSerialized)
            {
                If (\_SB.ECOK)
                {
                    ...
                    {
                        Store ("BODEN31", Index (PBIF, 0x09))
                    }

                    If (LEqual (Local3, 0x0E))
                    {
                        Store ("BODEN32", Index (PBIF, 0x09))
                    }
                    ...
                    {
                        Store ("BODEN34", Index (PBIF, 0x09))
                    }

                    If (LEqual (Local3, 0x11))
                    {
                        Store ("BODEN35", Index (PBIF, 0x09))
                    }

                    If (LEqual (Local3, 0x12))
                    {
                        Store ("BODEN41", Index (PBIF, 0x09))
                    }

                    If (LEqual (Local3, 0x13))
                    {
                        Store ("BODEN42", Index (PBIF, 0x09))
                    }

                    If (LEqual (Local3, 0x14))
                    {
                        Store ("BODEN43", Index (PBIF, 0x09))
                    }

                    If (LEqual (Local3, 0x15))
                    {
                        Store ("BODEN44", Index (PBIF, 0x09))
                    }

                    If (LEqual (Local3, 0x16))
                    {
                        Store ("BODEN71", Index (PBIF, 0x09))
                    }

                    If (LEqual (Local3, 0x17))
                    {
                        Store ("BODEN72", Index (PBIF, 0x09))
                    }

                    If (LEqual (Local3, 0x18))
                    {
                        Store ("BODEN73", Index (PBIF, 0x09))
                    }
                    ...
                    Else
                    {
                        If (Or (LEqual (Local4, 0x07), LEqual (Local4, 0x0B)))
                        {
        ...
        Scope (\_TZ)
        {
            ThermalZone (THRM)
            {
                ...
                {
                    Return (Add (Multiply (0x60, 0x0A), 0x0AAC))
                }
