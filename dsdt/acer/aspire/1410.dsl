 ...
 *
 * Disassembly of 1410, Mon Jul 16 12:32:05 2007
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00005B6C (23404)
 *     Revision         0x01
 *     OEM ID           "ACER  "
 *     OEM Table ID     "Kestrel "
 *     OEM Revision     0x20020806 (537004038)
 *     Creator ID       "INTL"
 *     Creator Revision 0x20050513 (537199891)
 */
DefinitionBlock ("1410.aml", "DSDT", 1, "ACER  ", "Kestrel ", 0x20020806)
{
    ...
    Method (_WAK, 1, NotSerialized)
    {
        ...
        If (LEqual (SizeOf (_OS), 0x14))
        {
            ...
            {
                If (Or (LEqual (Local1, One), LEqual (Local1, 0x02)))
                {
                    ...
                    Else
                    {
                        Notify (\_SB.PCI0.IDE0.SECN.BAY1, One)
                    }
                }
            }
            ...
            {
                Notify (\_SB.PCI0.IDE0.SECN.BAY1, Zero)
            }
            ...
            Device (LPC0)
            {
                ...
                Device (SIO)
                {
                    ...
                    Device (ECP)
                    {
                        ...
                        Method (_STA, 0, NotSerialized)
                        {
                            Store (LDRG (One, 0xF0), Local0)
                            ShiftRight (Local0, 0x05, Local0)
                            If (LGreater (MBTP, One))
                            {
                                Return (Zero)
                            }
                            ...
                            If (LAnd (RCF6 (0x02), LOr (LEqual (Local0, 0x04), LEqual (Local0, 
                                0x07))))
                            {
                                ShiftLeft (LDRG (One, 0x30), One, Local1)
                        ...
                        Method (_CRS, 0, NotSerialized)
                        {
                            ...
                            Store (LDRG (One, 0x60), Local1)
                            Store (LDRG (One, 0x61), Local0)
                        ...
                        Method (_SRS, 1, NotSerialized)
                        {
                            ...
                            Decrement (Local1)
                            LDRS (One, 0x70, Local0)
                            LDRS (One, 0x74, Local1)
                            LDRS (One, 0x60, ADRM)
                            LDRS (One, 0x61, ADRL)
                            LDRS (One, 0x30, One)
                        }
                    ...
                    Device (LPTB)
                    {
                        ...
                        Method (_STA, 0, NotSerialized)
                        {
                            ...
                            If (LAnd (RCF6 (0x02), LEqual (Local0, One)))
                            {
                                ShiftLeft (LDRG (One, 0x30), One, Local1)
                                Add (0x0D, Local1, Local1)
                                Return (Local1)
                    ...
                    Device (LPT)
                    {
                        ...
                        Method (_STA, 0, NotSerialized)
                        {
                            ...
                            If (LAnd (RCF6 (0x02), LEqual (Local0, Zero)))
                            {
                                ShiftLeft (LDRG (One, 0x30), One, Local1)
                                Add (0x0D, Local1, Local1)
                                Return (Local1)
                    ...
                    Device (COMA)
                    {
                        ...
                        Method (_STA, 0, NotSerialized)
                        {
                            ...
                            If (RCF6 (0x08))
                            {
                                ShiftLeft (LDRG (0x03, 0x30), One, Local1)
                                Add (0x0D, Local1, Local1)
                                Return (Local1)
                            }
                            Else
                        ...
                        Method (_CRS, 0, NotSerialized)
                        {
                            ...
                            Store (Local1, Index (DCRS, 0x03))
                            Store (Local1, Index (DCRS, 0x05))
                            ShiftLeft (One, LDRG (0x03, 0x70), Local0)
                    ...
                    Device (FIR)
                    {
                        ...
                        {
                            If (LOr (LEqual (MYOS, One), LEqual (MYOS, 0x03)))
                            {
                                Return (0x0160633A)
                            }
                            Else
                        ...
                        Method (_STA, 0, NotSerialized)
                        {
                            ...
                            {
                                ShiftLeft (LDRG (0x02, 0x30), One, Local1)
                                Add (0x0D, Local1, Local1)
                                Return (Local1)
                            }
                            Else
                        ...
                        Method (_CRS, 0, NotSerialized)
                        {
                            ...
                            Store (Local1, Index (DCRS, 0x03))
                            Store (Local1, Index (DCRS, 0x05))
                            ShiftLeft (One, LDRG (0x02, 0x70), Local0)
                            Store (Local0, Index (DCRS, 0x09))
                            ShiftRight (Local0, 0x08, Local1)
                            Store (Local1, Index (DCRS, 0x0A))
                            ShiftLeft (One, LDRG (0x02, 0x74), Local0)
                            Store (Local0, Index (DCRS, 0x0C))
                            ShiftRight (Local0, 0x08, Local1)
                            Store (Local1, Index (DCRS, 0x0D))
                            Return (DCRS)
                ...
                Device (EC0)
                {
                    ...
                    Method (_Q8A, 0, NotSerialized)
                    {
                        ...
                        If (DB2E)
                        {
                            ...
                            Store (One, DB2E)
                            Store (0xB1, P80H)
                            If (Or (LEqual (MYOS, One), LEqual (MYOS, 0x03)))
                            {
                                If (DB2S)
                                {
                                    Store (0xB2, P80H)
                                    ...
                                    Else
                                    {
                                        ...
                                        Store (One, ^^^IDE0.SSIG)
                                        Store (One, ^^^IDE0.UDC1)
                                        Store (0x02, ^^^IDE0.UDT1)
                                        Or (^^^IDE0.FSCB, 0x04, ^^^IDE0.FSCB)
                                        Store (0xE303, ^^^IDE0.ITM1)
                                        Store (Zero, ^^^IDE0.SSIG)
                                        Notify (^^^IDE0.SECN.BAY1, Zero)
                                        Store (0xB6, P80H)
                                    }
                                }
                                Else
                                {
                                    ...
                                    Store (^^^IDE0.BAYR, Local0)
                                    Store (One, LV37)
                                    Sleep (0xC8)
                                    If (Or (LEqual (Local0, One), LEqual (Local0, 0x02)))
                                    {
                                        Notify (^^^IDE0.SECN.BAY1, One)
                                        Store (0xB8, P80H)
                                    }
                                }
                            }
                ...
                OperationRegion (SMI1, SystemMemory, 0x1EEFCEBD, 0x90)
