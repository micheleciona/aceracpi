 ...
 *
 * Disassembly of 3500, Tue Feb  5 23:09:19 2008
 *
 *
 ...
 */
DefinitionBlock ("3500.aml", "DSDT", 1, "PTLTD ", "661MX", 0x06040000)
{
    External (Z004)
    ...
    {
        Name (OSTB, Ones)
        OperationRegion (OSTY, SystemMemory, 0x3BDFAE2C, 0x00000001)
    ...
    Scope (\_SB)
    {
        ...
        OperationRegion (SMI1, SystemMemory, 0x3BDFAE2D, 0x00000120)
