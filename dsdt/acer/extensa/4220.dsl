 ...
 *
 * Disassembly of 4220, Fri Aug 29 19:42:42 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008F9A (36762)
 *     Revision         0x02
 *     Checksum         0x05
 *     OEM ID           "INTEL "
 ...
 */
DefinitionBlock ("4220.aml", "DSDT", 2, "INTEL ", "CRESTLNE", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    External (CFGD)
    ...
    OperationRegion (GNVS, SystemMemory, 0x5F6DFDBC, 0x0100)
