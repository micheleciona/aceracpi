 ...
 *
 * Disassembly of 2400, Sat Nov  1 14:38:01 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00006CA2 (27810)
 ...
 */
DefinitionBlock ("2400.aml", "DSDT", 1, "Acer", "EFL50   ", 0x00000001)
{
    ...
    OperationRegion (MBOX, SystemMemory, 0x4F7FFC00, 0x0100)
            ...
            Device (LPCB)
            {
                ...
                Device (LDRC)
                {
                    ...
                    Name (BUF0, ResourceTemplate ()
                    {
                        ...
                        IO (Decode16,
                            0xFF20,             // Range Minimum
                            0xFF20,             // Range Maximum
                            0x01,               // Alignment
                            0x10,               // Length
                            )
                        Memory32Fixed (ReadWrite,
                ...
                Device (SIO)
                {
                    ...
                    Field (S217, ByteAcc, NoLock, Preserve)
                    {
                        AINX,   8, 
                        ADTA,   8
                    }
                ...
                Device (PS2S)
                {
                    ...
                    Name (PSSY, ResourceTemplate ()
                    {
                        IRQ (Edge, ActiveHigh, Exclusive, )
                            {12}
                    })
                    Name (PSSN, ResourceTemplate ()
                    {
                        IRQNoFlags ()
                            {}
                    })
                ...
                Device (PS2E)
                {
                    ...
                    Name (PSEY, ResourceTemplate ()
                    {
                        IRQ (Edge, ActiveHigh, Exclusive, )
                            {12}
                    })
                    Name (PSEN, ResourceTemplate ()
                    {
                        IRQNoFlags ()
                            {}
                    })
