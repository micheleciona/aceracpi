 ...
 *
 * Disassembly of 4200, Sun Feb 10 22:03:09 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00005D1A (23834)
 *     Revision         0x01
 *     Checksum         0x08
 *     OEM ID           "Acer  "
 ...
 */
DefinitionBlock ("4200.aml", "DSDT", 1, "Acer  ", "CALISTGA", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    External (CFGD)
    ...
    OperationRegion (GNVS, SystemMemory, 0x3F68DDBC, 0x0100)
    Field (GNVS, 
    {
        0x10
        OSYS,   16, 
    ...
    Scope (_SB)
    {
        ...
        OperationRegion (SMI1, SystemMemory, 0x3F68DEBD, 0x00000090)
        Field (SMI1, 
        {
            0x00
            WCMD,   8, 
