 ...
 */
DefinitionBlock ("6290.aml", "DSDT", 2, "INTEL ", "CALISTGA", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    External (CFGD)
        ...
        Device (PCI0)
        {
            ...
            Device (GFX0)
            {
                ...
                Device (DD04)
                {
                    ...
                    {
                        Store (\_SB.PHSR (0x0D, 0xFF), Local0)
                        Store (Local0, BRTN)
