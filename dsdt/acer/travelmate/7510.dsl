 ...
 *
 * Disassembly of 7510, Sun May 11 08:43:29 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00006181 (24961)
 *     Revision         0x01
 *     Checksum         0xC3
 *     OEM ID           "NVIDIA"
 *     OEM Table ID     "MCP51M"
 ...
 */
DefinitionBlock ("7510.aml", "DSDT", 1, "NVIDIA", "MCP51M", 0x06040000)
{
    Mutex (MSMI, 0x07)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Scope (\_SB)
            {
                OperationRegion (ASLD, SystemMemory, 0x7FF1BEBC, 0x00000100)
            ...
            Device (COMB)
            {
                ...
                Method (_CRS, 0, NotSerialized)
                {
                    CreateWordField (CRSA, \_SB.PCI0.COMB._Y08._MIN, MINA)
                    CreateWordField (CRSA, \_SB.PCI0.COMB._Y08._MAX, MAXA)
                    CreateWordField (CRSA, \_SB.PCI0.COMB._Y09._INT, LKAA)
                    Store (Zero, MINA)
                    Store (Zero, MAXA)
                    Store (Zero, LKAA)
                    CreateWordField (CRSB, \_SB.PCI0.COMB._Y0A._MIN, MINB)
                    CreateWordField (CRSB, \_SB.PCI0.COMB._Y0A._MAX, MAXB)
                    CreateWordField (CRSB, \_SB.PCI0.COMB._Y0B._INT, LKBB)
                    CreateByteField (CRSB, \_SB.PCI0.COMB._Y0C._DMA, DMAB)
                    Store (Zero, MINB)
                    Store (Zero, MAXB)
                    Store (Zero, LKBB)
                    Store (Zero, DMAB)
            ...
            Scope (\_SB.PCI0.LPC0)
            {
                ...
                OperationRegion (SMI1, SystemMemory, 0x7FF1BDBC, 0x00000090)
            ...
            Device (MMTM)
            {
                ...
                Method (_CRS, 0, Serialized)
                {
                    If (\_SB.PCI0.LPC0.MTSE)
                    {
                        CreateDWordField (BUF0, \_SB.PCI0.MMTM._Y0D._BAS, TBAS)
                        CreateDWordField (BUF0, \_SB.PCI0.MMTM._Y0D._LEN, TLEN)
