 ...
 *
 * Disassembly of 2480, Mon Nov 12 23:29:28 2007
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008AA7 (35495)
 *     Revision         0x01
 *     OEM ID           "INTEL "
 ...
 */
DefinitionBlock ("2480.aml", "DSDT", 1, "INTEL ", "CALISTGA", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    ...
    OperationRegion (GNVS, SystemMemory, 0x3F69CD2C, 0x0100)
    ...
    Scope (\_SB)
    {
        ...
        OperationRegion (SMI1, SystemMemory, 0x3F69CE2D, 0x00000120)
