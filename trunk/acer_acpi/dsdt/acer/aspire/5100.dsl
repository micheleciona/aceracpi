/*
  RSD PTR: OEM=ACRSYS, ACPI_Rev=1.0x (0)
	RSDT=0x57e917d9, cksum=220
 */
/*
  RSDT: Length=56, Revision=1, Checksum=237,
	OEMID=ACRSYS, OEM Table ID=  RSDT, OEM Revision=0x6040000,
	Creator ID= LTP, Creator Revision=0x0
	Entries={ 0x57e99c04, 0x57e99c78, 0x57e99dee, 0x57e99f70, 0x57e99fc4 }
 */
/*
  FACP: Length=116, Revision=1, Checksum=124,
	OEMID=ATI, OEM Table ID=Bowfin, OEM Revision=0x6040000,
	Creator ID=ATI, Creator Revision=0xf4240
 	FACS=0x57e9afc0, DSDT=0x57e91811
	INT_MODEL=PIC
 ...
 */
/*
  DSDT: Length=33779, Revision=1, Checksum=119,
	OEMID=Acer, OEM Table ID=Navarro, OEM Revision=0x6040000,
 ...
 *
 * Disassembly of /tmp/acpidump.Vk8Mgt, Wed Dec 20 21:49:51 2006
 */
DefinitionBlock ("DSDT.aml", "DSDT", 1, "Acer", "Navarro", 100925440)
{
    Name (Z000, 0x01)
    Name (Z001, 0x02)
    Name (Z002, 0x04)
    ...
    Name (Z007, 0x0B)
    Name (Z008, 0x09)
    OperationRegion (MNVT, SystemMemory, 0x57E9AF60, 0x20)
    ...
    {
        Name (OSTB, Ones)
        OperationRegion (OSTY, SystemMemory, 0x57E9AEF0, 0x00000001)
    ...
    Scope (\_SB)
    {
        ...
        Device (WMID)
        {
            ...
            Name (_WDG, Buffer (0xDC)
            {
                ...
                , 
            ...
            Method (WMBC, 3, NotSerialized)
            {
                ...
                Else
                {
                    ShiftRight (DerefOf (Index (BCDS, Subtract (Arg1, 0x0A))), 0x10, BUFF)
                }
            ...
            Method (WMBD, 3, NotSerialized)
            {
                ...
                {
                    Z00H (Arg1, Arg2)
                    ShiftRight (DerefOf (Index (BCDS, Add (Arg1, 0x05))), 0x10, BUFF)
                    Return (BUFF)
                }
        ...
        OperationRegion (SMI2, SystemMemory, 0x57E9ADD0, 0x00000120)
        ...
        Device (PCI0)
        {
            ...
            OperationRegion (K8ST, SystemMemory, 0x57E9AF74, 0x00000048)
            ...
            Device (SMB)
            {
                ...
                OperationRegion (Z00V, PCI_Config, 0x08, 0x01)
                    ...
                    Method (_PS0, 0, NotSerialized)
                    {
                        ...
                        If (LEqual (Local0, 0x03))
                        {
                            ...
                            While (\_SB.PCI0.LPC0.INF)
                            {
                                ...
                                Store (Zero, \_SB.PCI0.LPC0.SMIC)
                                If (LAnd (LEqual (\_SB.PCI0.LPC0.INF, 0x01), LNot (LLess (\_SB.OSTB, 0x04))))
                                {
                                    Sleep (0x01F4)
                                }
                            }
            ...
            Device (LPC0)
            {
                ...
                OperationRegion (SMI1, SystemMemory, 0x57E9ADD0, 0x00000120)
                    ...
                    Device (FIR)
                    {
                        ...
                        Method (_CRS, 0, NotSerialized)
                        {
                            Name (BUF0, ResourceTemplate ()
                            {
                                ...
                                IO (Decode16, 0x0228, 0x0228, 0x01, 0x08)
                                IRQNoFlags () {3}
                            ...
                            CreateByteField (BUF0, 0x11, IRQV)
                            CreateByteField (BUF0, 0x14, DMAC)
                            Acquire (S1K, 0xFFFF)
                            ENFG ()
                            If (LEqual (U2MD, 0x01))
                            {
                                If (LNot (LEqual (CR2B, 0x00)))
                                {
                                    Store (CR25, Local0)
                                    Store (Local0, Local1)
                        ...
                        Name (_PRS, ResourceTemplate ()
                        {
                            ...
                            StartDependentFn (0x00, 0x01)
                            {
                                ...
                                IO (Decode16, 0x0220, 0x0220, 0x01, 0x08)
                                IRQNoFlags () {3}
                                DMA (Compatibility, NotBusMaster, Transfer8) {3}
                            }
                            StartDependentFn (0x00, 0x01)
                            {
                                ...
                                IO (Decode16, 0x0238, 0x0238, 0x01, 0x08)
                                IRQNoFlags () {3}
                                DMA (Compatibility, NotBusMaster, Transfer8) {3}
                            }
                            EndDependentFn ()
                ...
                Device (EC0)
                {
                    ...
                    Method (_Q11, 0, NotSerialized)
                    {
                        If (LEqual (OSYS, 0x40))
                        {
                            ...
                            Else
                            {
                                Notify (\_SB.PCI0.PEG.VGA.LCD, 0x87)
                            }
                        }
                        Else
                        {
                    ...
                    Method (_Q12, 0, NotSerialized)
                    {
                        If (LEqual (OSYS, 0x40))
                        {
                            ...
                            Else
                            {
                                Notify (\_SB.PCI0.PEG.VGA.LCD, 0x86)
                            }
                        }
                        Else
                        {
