 ...
 *
 * Disassembly of dsdt.dat, Wed Sep 28 15:38:18 2005
 */
DefinitionBlock ("DSDT.aml", "DSDT", 1, "INTEL ", "ALVISO  ", 100925440)
{
    ...
    OperationRegion (MNVS, SystemMemory, 0x3F689D2C, 0x0100)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (GFX0)
            {
                ...
                OperationRegion (VNVS, SystemMemory, 0x3F689E2C, 0x00010000)
        ...
        OperationRegion (SMI1, SystemMemory, 0x3F699E2D, 0x00000120)
