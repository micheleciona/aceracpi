 ...
 *
 * Disassembly of dsdt.aml, Sat Aug 21 14:31:55 2004
 */
DefinitionBlock ("DSDT.aml", "DSDT", 1, "ACER  ", "IBIS    ", 537003568)
{
            ...
            Device (LPC0)
            {
                ...
                Device (MBRD)
                {
                    ...
                    Name (RSRC, ResourceTemplate ()
                    {
                        ...
                        Memory32Fixed (ReadOnly, 0xFEBFF100, 0x00000B00)
                    ...
                    Method (_CRS, 0, NotSerialized)
                    {
                        ...
                        Store (GPMN, GPMX)
                        CreateDWordField (RSRC, 0x012C, TMEM)
                ...
                Device (SIO)
                {
                    ...
                    Device (SIR)
                    {
                        ...
                        Method (_STA, 0, NotSerialized)
                        {
                            ...
                            If (LAnd (RCF6 (0x04), LEqual (Local0, 0x04)))
                            {
                ...
                Device (EC0)
                {
                    ...
                    Method (_Q8A, 0, NotSerialized)
                    {
                        ...
                        If (DB2E)
                        {
                            ...
                            If (DB2S)
                            {
                                ...
                                If (\_SB.PCI0.LPC0.EC0.SXFG)
                                {
                                    Store (0x00, \_SB.PCI0.LPC0.EC0.SXFG)
                    ...
                    Name (SXFG, 0x00)
                    Method (BRSM, 0, NotSerialized)
                    {
                        If (LEqual (\_SB.PCI0.LPC0.RBID, 0x03))
                        {
                            Store ("-------- Device Bay Event ------ OUT ", Debug)
                            Store (0x01, \_SB.PCI0.LPC0.EC0.SXFG)
                            Store (0x01, \_SB.PCI0.LPC0.LV37)
                            Notify (\_SB.PCI0.IDE0.SECN.BAY1, 0x01)
                        }
                        Else
                    ...
                    {
                        If (LEqual (\_SB.PCI0.LPC0.LV16, 0x00))
                        {
                            Store (0x01, \_SB.PCI0.LPC0.LV16)
                        }
                        Else
                        {
                            Store (0x00, \_SB.PCI0.LPC0.LV16)
                        }
                    }
                }
                ...
                OperationRegion (SMI1, SystemMemory, 0x1FF7CEBD, 0x00000090)
