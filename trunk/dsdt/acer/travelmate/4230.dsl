 ...
 *
 * Disassembly of 4230, Fri Aug 29 19:45:13 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00005DA3 (23971)
 ...
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20050228 (537199144)
 */
DefinitionBlock ("4230.aml", "DSDT", 1, "Acer  ", "CALISTGA", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    External (CFGD)
    ...
    OperationRegion (GNVS, SystemMemory, 0x7F68DDBC, 0x0100)
    ...
    Scope (_SB)
    {
        ...
        OperationRegion (SMI1, SystemMemory, 0x7F68DEBD, 0x00000090)
        ...
        Device (PCI0)
        {
            ...
            Device (RP03)
            {
                ...
                {
                    Name (_ADR, Zero)
                    OperationRegion (P3FG, PCI_Config, Zero, 0x08)
                    Field (P3FG, DWordAcc, NoLock, Preserve)
                    {
                        P3ID,   32
                    }
