 ...
 *
 * Disassembly of 240, Sun Aug 30 22:12:41 2009
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00005099 (20633)
 ...
 */
DefinitionBlock ("240.aml", "DSDT", 1, "ANNI", "Yuhina", 0x06040000)
{
    ...
    OperationRegion (MNVS, SystemMemory, 0x2EEEBF09, 0x40)
    ...
    Scope (\_PR)
    {
        Processor (CPU0, 0x00, 0x00001010, 0x06)
        {
            ...
            {
                If (And (LEqual (CSTX, 0x00), LEqual (\_SB.PCI0.LPCB.SPST, One)))
                {
                    If (0x01)
                    {
                        Return (Package (0x05)
            ...
            Method (_PPC, 0, NotSerialized)
            {
                ...
                Else
                {
                    If (LEqual (\_SB.PCI0.LPCB.SPST, One))
                    {
                        Return (0x00)
                    }
                    Else
    ...
    Scope (\_GPE)
    {
        ...
        {
            Notify (\_SB.PCI0.PCIB.LANC, 0x02)
        }
    ...
    Scope (\_SB)
    {
        Device (BAT0)
        {
            ...
            {
                If (LEqual (\_SB.PCI0.LPCB.EC.COMD (0xC5, 0x19), One))
                {
                    Store (Zero, \_SB.PCI0.LPCB.C3C4)
                }
                Else
                {
                    Store (One, \_SB.PCI0.LPCB.C3C4)
                }
            ...
            Method (UPBI, 0, NotSerialized)
            {
                ...
                If (LEqual (BVA0, 0x0C))
                {
                    Store (0x0898, Index (PBIF, 0x01))
                    Store (0x0898, Index (PBIF, 0x02))
                    Store (0x39D0, Index (PBIF, 0x04))
                    Store (0x16, Index (PBIF, 0x05))
                    Store (0x0C, Index (PBIF, 0x06))
                    Store (0x0A, Index (PBIF, 0x07))
                    Store (0x0882, Index (PBIF, 0x08))
                ...
                If (LEqual (BVA0, 0x18))
                {
                    ...
                    Store (0x39D0, Index (PBIF, 0x04))
                    Store (0x82, Index (PBIF, 0x05))
                    Store (0x78, Index (PBIF, 0x06))
                    Store (0x0A, Index (PBIF, 0x07))
                    Store (0x0F1E, Index (PBIF, 0x08))
                ...
                If (LEqual (BVA0, 0x1C))
                {
                    Store (0x16F8, Index (PBIF, 0x01))
                    Store (0x16F8, Index (PBIF, 0x02))
                    Store (0x39D0, Index (PBIF, 0x04))
                    Store (0x3A, Index (PBIF, 0x05))
                    Store (0x30, Index (PBIF, 0x06))
                    Store (0x0A, Index (PBIF, 0x07))
                    Store (0x16BE, Index (PBIF, 0x08))
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Device (EC)
                {
                    ...
                    {
                        Store (0x31, P80H)
                        If (\_SB.PCI0.LPCB.EC.COMD (0xC5, 0x19))
                        {
                            If (\_SB.PCI0.LPCB.SPST)
                            {
                                Store (0x00, \_PR.CPU0.BTAT)
                            }
                ...
                Device (FDC)
                {
                    ...
                    {
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.FDC._Y17._MIN, MINA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.FDC._Y17._MAX, MAXA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.FDC._Y18._MIN, MINB)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.FDC._Y18._MAX, MAXB)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.FDC._Y19._INT, INTA)
                        CreateByteField (CRSA, \_SB.PCI0.LPCB.FDC._Y1A._DMA, DMAB)
                        If (REGR (0x00, 0x30))
                        {
                            Store (_PRS, CRSA)
                        }
                    ...
                    Method (_SRS, 1, NotSerialized)
                    {
                        ...
                        REGW (0x00, 0x74, Local0)
                        ShiftRight (MINA, 0x08, Local0)
                        REGW (0x00, 0x60, Local0)
                        And (MINA, 0xFF, Local0)
                        REGW (0x00, 0x61, Local0)
                        REGW (0x00, 0x30, One)
                    }
                }
                ...
                Device (LPT)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)
                    {
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.LPT._Y1B._MIN, MINA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.LPT._Y1B._MAX, MAXA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.LPT._Y1C._INT, INTA)
                        CreateByteField (CRSA, \_SB.PCI0.LPCB.LPT._Y1B._LEN, LENA)
                        Store (Zero, MINA)
                        Store (Zero, MAXA)
                        Store (Zero, INTA)
                        Store (Zero, LENA)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y1D._MIN, MINB)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y1D._MAX, MAXB)
                        CreateByteField (CRSB, \_SB.PCI0.LPCB.LPT._Y1D._LEN, LENB)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y1E._MIN, MINC)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y1E._MAX, MAXC)
                        CreateByteField (CRSB, \_SB.PCI0.LPCB.LPT._Y1E._LEN, LENC)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y1F._INT, INTB)
                        CreateByteField (CRSB, \_SB.PCI0.LPCB.LPT._Y20._DMA, DMAB)
                        Store (Zero, MINB)
                        Store (Zero, MAXB)
                        Store (Zero, LENB)
                        Store (Zero, MINC)
                ...
                Device (COMB)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)
                    {
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.COMB._Y21._MIN, MINA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.COMB._Y21._MAX, MAXA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.COMB._Y22._INT, INTA)
                        Store (Zero, MINA)
                        Store (Zero, MAXA)
                        Store (Zero, INTA)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.COMB._Y23._MIN, MINB)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.COMB._Y23._MAX, MAXB)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.COMB._Y24._INT, INTB)
                        CreateByteField (CRSB, \_SB.PCI0.LPCB.COMB._Y25._DMA, DMAB)
                        Store (Zero, MINB)
                        Store (Zero, MAXB)
                        Store (Zero, INTB)
                        Store (Zero, DMAB)
                ...
                Device (COMA)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)
                    {
                        ...
                        If (CMAP)
                        {
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.COMA._CRS._Y26._MIN, IOL0)
                            CreateByteField (BUF0, 0x03, IOH0)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.COMA._CRS._Y26._MAX, IOL1)
                            CreateByteField (BUF0, 0x05, IOH1)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.COMA._CRS._Y26._LEN, LEN0)
                            CreateWordField (BUF0, \_SB.PCI0.LPCB.COMA._CRS._Y27._INT, IRQW)
