 ...
 *
 * Disassembly of ../dsdt, Fri Nov 17 08:50:51 2006
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00006EE1 (28385)
 *     Revision         0x01
 *     OEM ID           "INTEL "
 ...
 */
DefinitionBlock ("..aml", "DSDT", 1, "INTEL ", "CALISTGA", 0x06040000)
{
    External (Z004)
    External (PDC1)
    External (PDC0)
    ...
    OperationRegion (GNVS, SystemMemory, 0x1F69BD2C, 0x0100)
	...
	Return(Package(0x02){0x00, 0x00}) /* PM*/
    }
    ...
    Scope (\_SB)
    {
        ...
        OperationRegion (SMI1, SystemMemory, 0x1F69BE2D, 0x00000120)
