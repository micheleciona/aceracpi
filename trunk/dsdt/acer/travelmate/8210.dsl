 ...
 *
 * Disassembly of 8210, Tue Dec 25 17:55:39 2007
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000099F8 (39416)
 *     Revision         0x01
 *     OEM ID           "INTEL "
 ...
 */
DefinitionBlock ("8210.aml", "DSDT", 1, "INTEL ", "CALISTGA", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    ...
    OperationRegion (GNVS, SystemMemory, 0x7FE97D2C, 0x0100)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (PDRC)
            {
                ...
                Name (BUF1, ResourceTemplate ()
                {
                    ...
                    Memory32Fixed (ReadWrite,
                        0xB0501000,         // Address Base
                        0x00002000,         // Address Length
                        )
                    Memory32Fixed (ReadWrite,
                        0xF2BFE100,         // Address Base
            ...
            Device (RP06)
            {
                ...
                Scope (\_SB.PCI0)
                {
                    Device (DOCK)
                    {
                        ...
                        Method (_STA, 0, NotSerialized)
                        {
                            If (LEqual (\_SB.PCI0.RP06.LDP6, 0x01))
                            {
                                Return (0x00)
                            }
                            Else
                ...
                Device (PXHA)
                {
                    ...
                    Method (_INI, 0, NotSerialized)
                    {
                        If (LEqual (\_SB.PCI0.RP06.PDS6, 0x01))
                        {
            ...
            Device (PATA)
            {
                ...
                Device (PRID)
                {
                    ...
                    Device (PBAY)
                    {
                        ...
                        Method (_INI, 0, NotSerialized)
                        {
                            Store (\_SB.PCI0.PATA.PRID.PBAY._STA (), Local0)
                            If (Local0)
                            {
                        ...
                        Method (_STA, 0, NotSerialized)
                        {
                            ...
                            Store (\_SB.PCI0.SATA.SMS, Local1)
                            If (LAnd (LEqual (Local0, 0x00), LNotEqual (Local1, 0x00)))
                            {
                                Store (\_SB.PCI0.SATA.Z002 (), Local0)
                        ...
                        Method (_EJ0, 1, NotSerialized)
                        {
                            If (Arg0)
                            {
                                ...
                                Store (0x01, BAYR)
                                Sleep (0x01F4)
                                Store (\_SB.PCI0.PATA.ICR4, Local0)
                                Or (And (Local0, 0x03), 0x01, Local0)
                                Store (Local0, \_SB.PCI0.PATA.ICR4)
                            }
                        }
                        ...
                        Method (BAYF, 0, NotSerialized)
                        {
                            ...
                            If (Local0)
                            {
                                Store (0x01, \_SB.PCI0.PATA.PRID.PBAY.IDER)
                                Store (0xAA, P80H)
                            }
                            Else
                            {
                                Store (0x00, \_SB.PCI0.PATA.PRID.PBAY.IDER)
                                Store (0x55, P80H)
                            }
                ...
                Device (SECD)
                {
                    ...
                    Device (SBAY)
                    {
                        ...
                        Method (_STA, 0, NotSerialized)
                        {
                            Store (\_SB.PCI0.SATA.PRID.PBAY._STA (), Local0)
                            Store (\_SB.PCI0.SATA.SMS, Local1)
                            If (LAnd (LEqual (Local0, 0x00), LEqual (Local1, 0x00)))
                            {
                                Store (\_SB.PCI0.SATA.Z002 (), Local0)
                                If (Or (LEqual (Local0, 0x03), LEqual (Local0, 0x00)))
                                {
                            ...
                            If (Or (LEqual (Local0, 0x01), LEqual (Local0, 0x02)))
                            {
                                ...
                                If (BAYO)
                                {
                                    ...
                                    Else
                                    {
                                        ...
                                        Store (0x01, BAYR)
                                        Sleep (0x0BB8)
                                        Store (\_SB.PCI0.SATA.SMS, Local0)
                                        If (LEqual (Local0, 0x00))
                                        {
                                        ...
                                        Else
                                        {
                                            Notify (\_SB.PCI0.PATA.PRID.PBAY, 0x00)
                                        }
        ...
        OperationRegion (SMI1, SystemMemory, 0x7FE97E2D, 0x00000120)
