 ...
 *
 * Disassembly of 4730, Sun Dec 21 11:38:49 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000091DC (37340)
...
DefinitionBlock ("4730.aml", "DSDT", 1, "ACRSYS", "ACRPRDCT", 0x00000001)
{
    ...
    OperationRegion (MBOX, SystemMemory, 0x7FEBEC18, 0x000002BC)
    ...
    OperationRegion (NVST, SystemMemory, 0x7FEBEED4, 0x000000DE)
                                                                                                ...
                                                                                                Else
                                                                                                {
                                                                                                    If (LEqual (_T_1, 0x13))
                                                                                                    {
                                                                                                        ...
                                                                                                        Else
                                                                                                        {
                                                                                                            If (LEqual (_T_2, 0x08))
                                                                                                            {
                                                                                                                Store (^^LPC.EC0.BPTC, Index (BEDS, 0x12))
                                                                                                            }
                                                                                                            Else
                                                                                                            {
                                                                                                                If (LEqual (_T_2, 0x09))
