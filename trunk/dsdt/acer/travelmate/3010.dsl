 ...
 *
 * Disassembly of DSDT.dat, Tue Jan 22 03:49:06 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000084DF (34015)
 *     Revision         0x01
 *     OEM ID           "INTEL "
...
DefinitionBlock ("DSDT.aml", "DSDT", 1, "INTEL ", "CALISTGA", 0x06040000)
{
    ...
    OperationRegion (PRT1, SystemIO, 0x0378, 0x01)
    ...
    OperationRegion (GNVS, SystemMemory, 0x3F697D2C, 0x0100)
    ...
    Method (_PTS, 1, NotSerialized)
    {
        ...
        If (\_SB.ECOK)
        {
            ...
            If (LEqual (\_SB.PCI0.RP02.LANE.LANP, 0x00))
            {
    ...
    Scope (\_SB)
    {
        ...
        OperationRegion (SMI1, SystemMemory, 0x3F697E2D, 0x00000120)
