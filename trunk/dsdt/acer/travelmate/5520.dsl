 ...
 *
 * Disassembly of 5520, Tue Dec 18 17:37:16 2007
 *
 *
 ...
 */
DefinitionBlock ("5520.aml", "DSDT", 1, "ATI", "SB600", 0x06040000)
{
    Name (Z000, 0x01)
    Name (Z001, 0x02)
    Name (Z002, 0x04)
    ...
    OperationRegion (GNVS, SystemMemory, 0x6FE939E4, 0x00000400)
    ...
    Field (\IRPO, ByteAcc, NoLock, Preserve)
    {
        IRTR,   8
    }
    ...
    Scope (\_SB)
    {
        Name (LINX, 0x00)
        Name (OSTB, Ones)
        OperationRegion (OSTY, SystemMemory, 0x6FE94DE4, 0x00000001)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Field (NBGC, DWordAcc, NoLock, Preserve)
            {
                GFXE,   1, 
                GFXI,   1
            }
            ...
            OperationRegion (K8ST, SystemMemory, 0x6FE94F74, 0x00000048)
            ...
            Device (PB2)
            {
                ...
                Field (PEX2, AnyAcc, NoLock, Preserve)
                {
                            Offset (0x68), 
                    PB2L,   2
                }
                ...
                Device (VGA)
                {
                    ...
                    Field (DISV, AnyAcc, NoLock, Preserve)
                    {
                                Offset (0x68), 
                        DISL,   2
                    }
            ...
            Device (LPC0)
            {
                ...
                OperationRegion (SMI1, SystemMemory, 0x6FE94DE5, 0x00000120)
