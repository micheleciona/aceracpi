 ...
 *
 * Disassembly of 6590, Thu Jan 31 10:40:58 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008726 (34598)
 *     Revision         0x02
 *     OEM ID           "INTEL "
 ...
 */
DefinitionBlock ("6590.aml", "DSDT", 2, "INTEL ", "CRESTLNE", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    External (CFGD)
    ...
    OperationRegion (GNVS, SystemMemory, 0x3EEC9DBC, 0x0100)
    ...
    Scope (_SB)
    {
        OperationRegion (SMI2, SystemMemory, 0x3EEC9EBD, 0x00000090)
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Scope (\_SB)
                {
                    OperationRegion (TCG1, SystemMemory, 0x3EEC7DB5, 0x00000007)
                    ...
                    OperationRegion (SMI1, SystemMemory, 0x3EEC9EBD, 0x00000090)
