 ...
 *
 * Disassembly of 5010.aml, Fri Nov 23 02:49:48 2007
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00004CD4 (19668)
 *     Revision         0x01
 *     OEM ID           "ATI"
 *     OEM Table ID     "SB400"
 ...
 */
DefinitionBlock ("5010.aml", "DSDT", 1, "ATI", "SB400", 0x06040000)
{
    Name (Z000, 0x01)
    Name (Z001, 0x02)
    Name (Z002, 0x04)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (LPC0)
            {
                ...
                {
                    OperationRegion (NSIO, SystemIO, 0x0500, 0x01)
