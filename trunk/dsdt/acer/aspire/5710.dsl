 ...
 *
 * Disassembly of 5710, Fri Dec  7 23:56:15 2007
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00005EE6 (24294)
 *     Revision         0x01
 *     OEM ID           "Acer  "
 *     OEM Table ID     "CALISTGA"
 *     OEM Revision     0x06040000 (100925440)
 *     Creator ID       "INTL"
 *     Creator Revision 0x20060608 (537265672)
 */
DefinitionBlock ("5710.aml", "DSDT", 1, "Acer  ", "CALISTGA", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    External (CFGD)
    ...
    OperationRegion (GNVS, SystemMemory, 0x3F68CDBC, 0x0100)
    ...
    Scope (_GPE)
    {
        ...
        {
            If (LEqual (\_SB.WMID.BGEF, One))
            {
                If (LNotEqual (CRTS, One))
                {
                    Store (One, CRTS)
                    Store (Zero, GIV0)
    ...
    Scope (_SB)
    {
        ...
        Device (WMID)
        {
            ...
            Method (Z000, 1, NotSerialized)
            {
                ...
                Store (^^PCI0.LPCB.EC0.LCDS, Local0)
