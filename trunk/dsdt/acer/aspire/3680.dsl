 ...
 *
 * Disassembly of 3680, Fri Oct 19 01:45:56 2007
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008AFB (35579)
 *     Revision         0x01
 *     OEM ID           "INTEL "
 ...
 */
DefinitionBlock ("3680.aml", "DSDT", 1, "INTEL ", "CALISTGA", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    ...
    OperationRegion (GNVS, SystemMemory, 0x2F69BD2C, 0x0100)
    ...
    Scope (\_SB)
    {
        ...
        OperationRegion (SMI1, SystemMemory, 0x2F69BE2D, 0x00000120)
