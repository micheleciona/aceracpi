 ...
 *
 * Disassembly of 4720, Mon Mar  3 20:16:18 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008DBA (36282)
 *     Revision         0x02
 *     Checksum         0x94
 *     OEM ID           "INTEL "
 ...
 */
DefinitionBlock ("4720.aml", "DSDT", 2, "INTEL ", "CRESTLNE", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    External (CFGD)
    ...
    OperationRegion (GNVS, SystemMemory, 0x3F6E0D2C, 0x0100)
    ...
    Scope (\_SB)
    {
        ...
        OperationRegion (SMI1, SystemMemory, 0x3F6E0E2D, 0x00000120)
            ...
            Device (WMID)
            {
                                    ...
                                    Else
                                    {
                                        ...
                                        Else
                                        {
                                            If (LEqual (_T_0, 0x0A))
                                            {
                                                ...
                                                {
                                                    Acquire (\_SB.PCI0.LPCB.EC0.MUT1, 0xFFFF)
                                                    Store (\_SB.PCI0.LPCB.EC0.ED3G, Local0)
                                                    Release (\_SB.PCI0.LPCB.EC0.MUT1)
                                                }
                                                Else
                                                {
                ...
                Method (Z002, 1, NotSerialized)
                {
                    ...
                    If (LGreater (Local0, BRTN))
                    {
                        ...
                        Else
                        {
                            Notify (\_SB.PCI0.GFX0.DD03, 0x86)
                        }
                    }
                    Else
                    {
                        If (LLess (Local0, BRTN))
                        {
                            ...
                            Else
                            {
                                Notify (\_SB.PCI0.GFX0.DD03, 0x87)
                            }
                        }
                    }
                }
