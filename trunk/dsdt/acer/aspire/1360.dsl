 ...
 *
 * Disassembly of 1360, Sat Sep 29 11:42:04 2007
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00006250 (25168)
 *     Revision         0x01
 *     OEM ID           "VIA  "
 ...
 */
DefinitionBlock ("1360.aml", "DSDT", 1, "VIA  ", "PTL_ACPI", 0x06040000)
{
    Scope (\)
    {
        Name (PICF, 0x00)
    ...
    Scope (\_SB)
    {
        ...
        OperationRegion (PSCB, SystemMemory, 0x1FF7AEBD, 0x00000090)
    ...
    {
        Name (OSTB, Ones)
        OperationRegion (OSTY, SystemMemory, 0x1FF7AEBC, 0x00000001)
    ...
    Scope (\_SB)
    {
        ...
        Method (WH15, 2, NotSerialized)
        {
            ...
            Store (0xA0, \_SB.BCMD)
            Store (Zero, \_SB.SMIC)
            Concatenate (\_SB.WNVA, \_SB.WNVB, Local0)
            Concatenate (\_SB.WNVC, \_SB.WNVD, Local1)
            Concatenate (Local0, Local1, B2ED)
            Store (\_SB.WFLG, Index (B2ED, 0x10))
            Release (VSMX)
            Return (B2ED)
        }
    }
