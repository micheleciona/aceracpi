...
DefinitionBlock ("dsdt.aml", "DSDT", 1, "ATI", "SB400", 0x06040000)
{
    ...
    {
        0x00, 0x00, 0x00, 0x00, /* eax */
        0x00, 0x00, 0x00, 0x00, /* ebx */
        0x00, 0x00, 0x00, 0x00, /* ecx */
        0x00, 0x00, 0x00, 0x00, /* edx */
        0x00, 0x00, 0x00, 0x00
    })
    ...
    Scope (\_SB)
    {
        ...
        Device (AMW0)
        {
            ...
            Name (_WDG, Buffer (0x3C)
            {
                ...
                0x93, 0x55, 0x60, 0x17, 0x70, 0xBE, 0xC5, 0x10, // GUID
                0x41, 0x41, // Object ID (AA)
                0x01,       // Instance Count
                0x00,       // Flags ()

                0x1D, 0x37, 0xC3, 0x67, 0xA3, 0x95, 0x37, 0x4C,
                0xBB, 0x61, 0xDD, 0x47, 0xB4, 0x91, 0xDA, 0xAB, // GUID
                0x41, 0x42, // Object ID (AB)
                0x01,       // Instance Count
                0x02,       // Flags (WMIACPI_REGFLAG_METHOD)

                0x71, 0xBF, 0xD1, 0x40, 0x2D, 0xA8, 0x59, 0x4E,
                0xA1, 0x68, 0x39, 0x85, 0xE0, 0x3B, 0x2E, 0x87, // GUID
                0xB0,       // Notification ID
                0x00,       // Reserved
                0x01,       // Instance Count (Not meaningful for events)
