 ...
 *
 * Disassembly of 5580.dat, Wed Jun 20 02:55:34 2007
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008C3E (35902)
 *     Revision         0x02
 *     OEM ID           "INTEL "
 ...
 */
DefinitionBlock ("5580.aml", "DSDT", 2, "INTEL ", "CALISTGA", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    ...
    OperationRegion (GNVS, SystemMemory, 0x3F69BD2C, 0x0100)
    ...
    Scope (\_SB)
    {
        ...
        OperationRegion (SMI1, SystemMemory, 0x3F69BE2D, 0x00000120)
