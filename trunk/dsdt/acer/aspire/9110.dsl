 ...
 *
 * Disassembly of 9110, Sun Jan 27 21:05:40 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00005D22 (23842)
 *     Revision         0x01
 *     OEM ID           "Acer  "
 ...
 */
DefinitionBlock ("9110.aml", "DSDT", 1, "Acer  ", "CALISTGA", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    External (CFGD)
    ...
    OperationRegion (GNVS, SystemMemory, 0x7FE8BDBC, 0x0100)
    ...
    Scope (_SB)
    {
        ...
        OperationRegion (SMI1, SystemMemory, 0x7FE8BEBD, 0x00000090)
