 ...
 *
 * Disassembly of 5520, Sun Dec  9 17:00:40 2007
 *
 *
 ...
 */
DefinitionBlock ("5520.aml", "DSDT", 1, "NVIDIA", "MCP67", 0x06040000)
{
    ...
    Name (SX, 0x00)
    Name (CRTS, 0x00)
    OperationRegion (MNVT, SystemMemory, 0x7FF65F9B, 0x21)
    ...
    Scope (\_SB)
    {
        ...
        {
            Name (OSTB, Ones)
            OperationRegion (OSTY, SystemMemory, 0x7FF65F2B, 0x00000001)
        ...
        OperationRegion (SMI1, SystemMemory, 0x7FF65E9B, 0x00000090)
        ...
        OperationRegion (SMI2, SystemMemory, 0x7FF65E9B, 0x00000090)
        ...
        Device (PCI0)
        {
            ...
            Scope (\_SB)
            {
                OperationRegion (ASLD, SystemMemory, 0x7FF65869, 0x00000100)
            ...
            Device (IGPU)
            {
                ...
                Scope (\_SB.PCI0)
                {
                    OperationRegion (HDCP, SystemMemory, 0x7FF65969, 0x00000532)
