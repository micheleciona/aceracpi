 ...
 *
 * Disassembly of 3050, Sat Jan 19 14:15:24 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00007028 (28712)
 *     Revision         0x01
 *     OEM ID           "ATI"
 *     OEM Table ID     "SB460"
 ...
 */
DefinitionBlock ("3050.aml", "DSDT", 1, "ATI", "SB460", 0x06040000)
{
    External (Z00K)
    External (Z00E)
    ...
    Scope (\_SB)
    {
        Name (LINX, 0x00)
        Name (OSTB, Ones)
        OperationRegion (OSTY, SystemMemory, 0x6FE9ADE4, 0x00000001)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            OperationRegion (K8ST, SystemMemory, 0x6FE9AF74, 0x00000048)
            ...
            Device (LPC0)
            {
                ...
                OperationRegion (SMI1, SystemMemory, 0x6FE9ADE5, 0x00000120)
