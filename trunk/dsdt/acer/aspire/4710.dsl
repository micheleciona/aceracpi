 ...
 *
 * Disassembly of 4710, Wed Nov  5 21:06:36 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00007619 (30233)
 ...
 */
DefinitionBlock ("4710.aml", "DSDT", 1, "INTEL ", "CALISTGA", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    External (CFGD)
    ...
    OperationRegion (Z000, SystemIO, 0x42, 0x01)
    Field (Z000, ByteAcc, NoLock, Preserve)
    {
        P42H,   8
    }

    OperationRegion (Z001, SystemIO, 0x43, 0x01)
    Field (Z001, ByteAcc, NoLock, Preserve)
    {
        P43H,   8
    }

    OperationRegion (Z002, SystemIO, 0x61, 0x01)
    ...
    OperationRegion (GNVS, SystemMemory, 0x3F69BE4C, 0x0100)
