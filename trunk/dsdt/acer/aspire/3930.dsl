 ...
 *
 * Disassembly of 3930, Sun Aug 30 22:05:44 2009
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000A3D1 (41937)
 *     Revision         0x02
 *     Checksum         0x03
 *     OEM ID           "Intel "
 ...
 */
DefinitionBlock ("3930.aml", "DSDT", 2, "Intel ", "CANTIGA ", 0x06040000)
{
    External (PDC3)
    External (PDC2)
    External (PDC1)
    ...
    Name (PDBR, 0x4D)
    Name (SMBL, 0x10)
    OperationRegion (CNVS, SystemMemory, 0xBBB9E020, 0x00000800)
    ...
    OperationRegion (GNVS, SystemMemory, 0xBBB9DDBC, 0x0100)
            ...
            Device (LPCB)
            {
                ...
                Scope (\_SB)
                {
                    Scope (\_SB)
                    {
                        ...
                        OperationRegion (SMI1, SystemMemory, 0xBBB9DEBD, 0x00000090)
                ...
                Scope (\_SB)
                {
                    Device (AMW0)
                    {
                        ...
                        Method (WMC9, 3, NotSerialized)
                        {
                            ...
                            If (LEqual (Arg1, 0x0A))
                            {
                                Store (I15H (0x03, 0x9610, 0x16, 0x00, 0x00), Local0)
                                If (And (Local0, 0xFF))
                                {
                                    Store (0x01, BUF0)
                                }
                        ...
                        Method (GACR, 0, NotSerialized)
                        {
                            ...
                            If (FIRE)
                            {
                                ...
                                If (LEqual (Local1, 0x0B00))
                                {
                                    Or (Local1, BBST, Local0)
                                }
