 ...
 *
 * Disassembly of acer5051.dsdt, Tue May 15 08:28:07 2007
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000062D8 (25304)
 *     Revision         0x01
 *     OEM ID           "ATI"
 *     OEM Table ID     "SB460"
 *     OEM Revision     0x06040000 (100925440)
 *     Creator ID       "INTL"
 *     Creator Revision 0x20060912 (537266450)
 */
DefinitionBlock ("acer5051.aml", "DSDT", 1, "ATI", "SB460", 0x06040000)
{
    External (Z00K)
    External (Z00E)
    ...
    OperationRegion (PLPT, SystemIO, 0x0378, One)
    Field (PLPT, ByteAcc, Lock, Preserve)
    {
        P378,   8
    }
    ...
    {
        Name (OSTB, Ones)
        OperationRegion (OSTY, SystemMemory, 0x1DE9CDE4, One)
    ...
    Scope (_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            OperationRegion (K8ST, SystemMemory, 0x1DE9CF74, 0x48)
            ...
            Scope (\_GPE)
            {
                Method (_L1F, 0, NotSerialized)
                {
                    ...
                    If (\_SB.PCI0.SATA.B5EN)
                    {
                        ...
                        {
                            Notify (\_SB.PCI0.SATA.PRID.P_D0, Zero)
                            Sleep (0x07D0)
                            Notify (\_SB.PCI0.SATA.PRID, One)
                            Sleep (0x07D0)
                        ...
                        {
                            Notify (\_SB.PCI0.SATA.SECD.S_D0, Zero)
                            Sleep (0x07D0)
                            Notify (\_SB.PCI0.SATA.SECD, One)
                            Sleep (0x07D0)
                    ...
                    If (\_SB.PCI0.SAT2.B5EN)
                    {
                        ...
                        {
                            Notify (\_SB.PCI0.SAT2.PRID.P_D0, Zero)
                            Sleep (0x07D0)
                            Notify (\_SB.PCI0.SAT2.PRID, One)
                            Sleep (0x07D0)
                        ...
                        {
                            Notify (\_SB.PCI0.SAT2.SECD.S_D0, Zero)
                            Sleep (0x07D0)
                            Notify (\_SB.PCI0.SAT2.SECD, One)
                            Sleep (0x07D0)
            ...
            Device (SMB)
            {
                ...
                OperationRegion (Z00A, PCI_Config, 0x08, One)
            ...
            Device (LPC0)
            {
                ...
                OperationRegion (SMI1, SystemMemory, 0x1DE9CDE5, 0x0120)
