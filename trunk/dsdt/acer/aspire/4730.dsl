 ...
 *
 * Disassembly of 4730, Sun Aug 30 22:29:15 2009
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000B15C (45404)
 ...
 */
DefinitionBlock ("4730.aml", "DSDT", 1, "ACRSYS", "ACRPRDCT", 0x00000001)
{
    Name (SP2O, 0x4E)
    Name (SP1O, 0x164E)
    Name (IO1B, 0x0600)
    ...
    OperationRegion (MBOX, SystemMemory, 0x7BABEC18, 0x000002BC)
    ...
    OperationRegion (NVST, SystemMemory, 0x7BABEED4, 0x000000E1)
    ...
    Scope (_GPE)
    {
        ...
        {
            Not (NEWD, NEWD)
            Store (\_SB.PCI0.EXP1.LPWR, Local2)
            Not (Local2, Local2)
            Store (Local2, \_SB.PCI0.EXP1.LPWR)
            Sleep (0x01F4)
            Notify (\_SB.PCI0.EXP1, Zero)
        }
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
		    ...
		    0x57, 0x93, 0x8A, 0xF2, 0x4B, 0xCF, 0x1A, 0x4A,
		    0x88, 0x93, 0xBB, 0x1F, 0x58, 0xEE, 0xA1, 0xAF,
		    0xD1, 0x00,
		    0x01,
		    0x08, /* Event */
            ...
            Device (LPC)
            {
                ...
                Device (EC0)
                {
                    ...
                    Method (_Q37, 0, NotSerialized)
                    {
                        ...
                        If (LNotEqual (^^^EXP5.J380.DVID, Ones))
                        {
                                        ...
                                        Else
                                        {
                                            ...
                                            Else
                                            {
                                                ...
                                                Else
                                                {
                                                    If (LEqual (_T_0, 0x0E))
                                                    {
                                                        Store (^^LPC.EC0.BBET, Index (BADG, 0x0D))
                                                    }
                                                }
                                            }
                                        }
		    ...
		    0x45, 0xDD, 0x23, 0x59, 0x80, 0x04, 0xD5, 0x4E,
		    0xB6, 0x1A, 0xC9, 0xEC, 0x6C, 0x90, 0xE2, 0x6A,
		    0x42, 0x48, 0x01, 0x02,
