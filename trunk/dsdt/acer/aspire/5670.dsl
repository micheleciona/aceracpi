 ...
 *
 * Disassembly of 5670, Tue Jul 17 00:44:06 2007
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00009A8A (39562)
 *     Revision         0x01
 *     OEM ID           "INTEL "
 ...
 */
DefinitionBlock ("5670.aml", "DSDT", 1, "INTEL ", "CALISTGA", 0x06040000)
{
    External (Z006)
    External (PDC1)
    External (PDC0)
    ...
    OperationRegion (GNVS, SystemMemory, 0x3FE99D2C, 0x0100)
    ...
    Method (_WAK, 1, NotSerialized)
    {
        ...
        Store (\_SB.PCI0.SATA.Z002 (), Local0)
        If (Or (LEqual (Local0, 0x00), LEqual (Local0, 0x03)))
        {
            Store (0x01, BAYO)
            Store (0x00, BAYR)
            If (LEqual (\_SB.PCI0.SATA.BAYE, 0x01))
            {
                Notify (\_SB.PCI0.SATA.SECD.SBAY, 0x03)
                Sleep (0x01F4)
            }

            If (LEqual (\_SB.PCI0.SATA.BAYE, 0x02))
            {
                Notify (\_SB.PCI0.SATA.PRID.PBAY, 0x03)
                Sleep (0x01F4)
            }

            Store (0x00, \_SB.PCI0.SATA.BAYE)
        }
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Device (SIO)
                {
                    ...
                    IndexField (I1K, D1K, AnyAcc, Lock, WriteAsOnes)
                    {
                    ...
                    Device (COMA)
                    {
                        ...
                        {
                            ENFG ()
                            Store (READ (0x00, 0x02, 0xC8), Local0)
                        ...
                        Method (_CRS, 0, NotSerialized)
                        {
                            ...
                            CreateByteField (RSRC, \_SB.PCI0.LPCB.SIO.COMA._CRS._Y17._MIN, IO1)
                            CreateByteField (RSRC, 0x03, IO2)
                            CreateByteField (RSRC, \_SB.PCI0.LPCB.SIO.COMA._CRS._Y17._MAX, IO3)
                            CreateByteField (RSRC, 0x05, IO4)
                            CreateWordField (RSRC, \_SB.PCI0.LPCB.SIO.COMA._CRS._Y18._INT, IRQV)
                            ENFG ()
                            If (APWR)
                            {
                                ShiftLeft (AADR, 0x02, Local0)
                                And (Local0, 0xFF, IO1)
                                ShiftRight (Local0, 0x08, IO2)
                                And (Local0, 0xFF, IO3)
                                ShiftRight (Local0, 0x08, IO4)
                                ShiftRight (AIRQ, 0x04, Local0)
                        ...
                        Method (_SRS, 1, NotSerialized)
                        {
                            ...
                            ENFG ()
                            ShiftLeft (IO2, 0x08, Local0)
                            Or (IO1, Local0, Local0)
                            ShiftRight (Local0, 0x02, AADR)
                            Store (IO2, Local0)
                            ShiftLeft (Local0, 0x08, Local0)
                            Add (Local0, IO1, Local0)
                            If (LEqual (Local0, 0x03F8))
                            {
                                Store (0x00, \_SB.PCI0.LPCB.UADR)
                            }

                            If (LEqual (Local0, 0x02F8))
                            {
                                Store (0x01, \_SB.PCI0.LPCB.UADR)
                            }

                            If (LEqual (Local0, 0x02E8))
                            {
                                Store (0x05, \_SB.PCI0.LPCB.UADR)
                            }

                            If (LEqual (Local0, 0x03E8))
                            {
                                Store (0x07, \_SB.PCI0.LPCB.UADR)
                            }
                            ...
                            And (AIRQ, 0x0F, Local1)
                            Or (Local0, Local1, AIRQ)
                            ENFG ()
                            Store (READ (0x00, 0x02, 0xC8), Local0)
                    ...
                    Device (FIR)
                    {
                        ...
                        Method (_CRS, 0, NotSerialized)
                        {
                            ...
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.FIR._Y19._MIN, IOLO)
                            CreateByteField (BUF0, 0x03, IOHI)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.FIR._Y19._MAX, IORL)
                            CreateByteField (BUF0, 0x05, IORH)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.FIR._Y1A._MIN, I2LO)
                            CreateByteField (BUF0, 0x0B, I2HI)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.FIR._Y1A._MAX, I2RL)
                            CreateByteField (BUF0, 0x0D, I2RH)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.FIR._Y1B._INT, IRQL)
                            CreateByteField (BUF0, 0x12, IRQH)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.FIR._Y1C._DMA, DMAC)
                            ENFG ()
                            Store (BADR, Local0)
                            Store (Local0, Local1)
                        ...
                        Method (_SRS, 1, NotSerialized)
                        {
                            ...
                            If (LEqual (Local0, 0x03F8))
                            {
                                Store (0x00, \_SB.PCI0.LPCB.UBDR)
                            }

                            If (LEqual (Local0, 0x02F8))
                            {
                                Store (0x01, \_SB.PCI0.LPCB.UBDR)
                            }

                            If (LEqual (Local0, 0x02E8))
                            {
                                Store (0x05, \_SB.PCI0.LPCB.UBDR)
                            }

                            If (LEqual (Local0, 0x03E8))
                            {
                                Store (0x07, \_SB.PCI0.LPCB.UBDR)
                            }
                    ...
                    Device (CIR)
                    {
                        ...
                        Method (_CRS, 0, NotSerialized)
                        {
                            ...
                            CreateByteField (RSRC, \_SB.PCI0.LPCB.SIO.CIR._CRS._Y1D._MIN, IO1)
                            CreateByteField (RSRC, 0x03, IO2)
                            CreateByteField (RSRC, \_SB.PCI0.LPCB.SIO.CIR._CRS._Y1D._MAX, IO3)
                            CreateByteField (RSRC, 0x05, IO4)
                            CreateWordField (RSRC, \_SB.PCI0.LPCB.SIO.CIR._CRS._Y1E._INT, IRQV)
                            ENFG ()
                            Store (CAD0, Local0)
                            Store (CAD1, Local1)
                        ...
                        Method (_SRS, 1, NotSerialized)
                        {
                            ...
                            Or (IO1, Local0, Local0)
                            Store (Local0, Local1)
                            And (Local0, 0x03F8, Local0)
                            ShiftRight (Local0, 0x02, Local0)
                            Store (Local0, CAD0)
                            And (Local1, 0xFC00, Local1)
                            ShiftRight (Local1, 0x0A, Local1)
                            Store (Local1, CAD1)
                            FindSetRightBit (IRQV, Local0)
                            Subtract (Local0, 0x01, CIRQ)
                            Store (READ (0x00, 0x02, 0xC8), Local0)
                    ...
                    Device (LPP)
                    {
                        ...
                        Method (_CRS, 0, NotSerialized)
                        {
                            ...
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.LPP._CRS._Y1F._MIN, IOLO)
                            CreateByteField (BUF0, 0x03, IOHI)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.LPP._CRS._Y1F._MAX, IORL)
                            CreateByteField (BUF0, 0x05, IORH)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.LPP._CRS._Y1F._LEN, LNA1)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.LPP._CRS._Y20._INT, IRQL)
                    ...
                    Device (LPBI)
                    {
                        ...
                        Method (_CRS, 0, NotSerialized)
                        {
                            ...
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.LPBI._CRS._Y21._MIN, IOLO)
                            CreateByteField (BUF0, 0x03, IOHI)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.LPBI._CRS._Y21._MAX, IORL)
                            CreateByteField (BUF0, 0x05, IORH)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.LPBI._CRS._Y21._LEN, LNA1)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.LPBI._CRS._Y22._INT, IRQL)
                            Store (READ (0x00, 0x23, 0xFF), Local0)
                            Store (Local0, Local1)
                            And (Local1, 0xC0, Local1)
                            ShiftRight (Local1, 0x06, Local1)
                    ...
                    Device (PECP)
                    {
                        ...
                        Method (_SRS, 1, NotSerialized)
                        {
                            ...
                            {
                                Store (0x01, \_SB.PCI0.LPCB.LPDR)
                            }

                            If (LEqual (Local0, 0x03BC))
                            {
                                Store (0x02, \_SB.PCI0.LPCB.LPDR)
                            }
                        ...
                        Method (_CRS, 0, NotSerialized)
                        {
                            ...
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.PECP._CRS._Y23._MIN, IOLO)
                            CreateByteField (BUF0, 0x03, IOHI)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.PECP._CRS._Y23._MAX, IORL)
                            CreateByteField (BUF0, 0x05, IORH)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.PECP._CRS._Y23._LEN, LNA1)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.PECP._CRS._Y24._MIN, DALO)
                            CreateByteField (BUF0, 0x0B, DAHI)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.PECP._CRS._Y24._MAX, DRLO)
                            CreateByteField (BUF0, 0x0D, DRHI)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.PECP._CRS._Y24._LEN, LNA2)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.PECP._CRS._Y25._INT, IRQL)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.PECP._CRS._Y26._DMA, DMAC)
                            Store (READ (0x00, 0x23, 0xFF), Local0)
                            Store (Local0, Local1)
                            And (Local1, 0xC0, Local1)
                            ShiftRight (Local1, 0x06, Local1)
                    ...
                    Device (LPPP)
                    {
                        ...
                        Method (_CRS, 0, NotSerialized)
                        {
                            ...
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.LPPP._CRS._Y27._MIN, IOLO)
                            CreateByteField (BUF0, 0x03, IOHI)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.LPPP._CRS._Y27._MAX, IORL)
                            CreateByteField (BUF0, 0x05, IORH)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.LPPP._CRS._Y27._LEN, LNA1)
                            CreateByteField (BUF0, \_SB.PCI0.LPCB.SIO.LPPP._CRS._Y28._INT, IRQL)
                            Store (READ (0x00, 0x23, 0xFF), Local0)
                            Store (Local0, Local1)
                            And (Local1, 0xC0, Local1)
                            ShiftRight (Local1, 0x06, Local1)
            ...
            Device (SATA)
            {
                ...
                Device (PRID)
                {
                    ...
                    Device (PBAY)
                    {
                        ...
                        Method (_INI, 0, NotSerialized)
                        {
                            Store (\_SB.PCI0.SATA.PRID.PBAY._STA (), Local0)
                            If (Local0)
                            {
                                Store (0x01, \_SB.PCI0.SATA.BAYE)
                            }
                            Else
                            {
                                Store (0x00, \_SB.PCI0.SATA.BAYE)
                        ...
                        Method (_STA, 0, NotSerialized)
                        {
                            Store (\_SB.PCI0.SATA.P2P, Local0)
                            If (Local0)
                            {
                                Return (0x0F)
                            }
                        ...
                        Method (BAYF, 0, NotSerialized)
                        {
                            ...
                            If (Local0)
                            {
                                Store (0x01, \_SB.PCI0.SATA.PRID.PBAY.IDER)
                                Store (0xAA, P80H)
                            }
                            Else
                            {
                                Store (0x00, \_SB.PCI0.SATA.PRID.PBAY.IDER)
                                Store (0x55, P80H)
                            }
                ...
                Device (SECD)
                {
                    ...
                    Device (SBAY)
                    {
                        ...
                        Method (_INI, 0, NotSerialized)
                        {
                            Store (\_SB.PCI0.SATA.SECD.SBAY._STA (), Local0)
                            If (Local0)
                            {
                                Store (0x02, \_SB.PCI0.SATA.BAYE)
                            }
                            Else
                            {
                                Store (0x00, \_SB.PCI0.SATA.BAYE)
                        ...
                        Method (BAYF, 0, NotSerialized)
                        {
                            ...
                            If (Local0)
                            {
                                Store (0x01, \_SB.PCI0.SATA.SECD.SBAY.IDER)
                                Store (0xAA, P80H)
                            }
                            Else
                            {
                                Store (0x00, \_SB.PCI0.SATA.SECD.SBAY.IDER)
                                Store (0x55, P80H)
                            }
                            ...
                            If (Or (LEqual (Local0, 0x01), LEqual (Local0, 0x02)))
                            {
                                ...
                                If (BAYO)
                                {
                                    ...
                                    If (Local0)
                                    {
                                        ...
                                        Or (Local0, 0x01, Local0)
                                        Store (Local0, \_SB.PCI0.SATA.ICR4)
                                        Notify (\_SB.PCI0.SATA.PRID.PBAY, 0x00)
                                        Sleep (0x01F4)
                                    }
                                    Else
                                    {
                                        ...
                                        Store (0x01, BAYR)
                                        Sleep (0x0BB8)
                                        Notify (\_SB.PCI0.SATA.SECD.SBAY, 0x00)
                                        Sleep (0x01F4)
                                    }
                                }
                            }
                ...
                Method (Z002, 0, NotSerialized)
                {
                    ...
                    Store (0x01, BID1)
                    Store (BID1, Local1)
                    ShiftLeft (Local1, 0x01, Local0)
                    Or (BID0, Local0, Local0)
                    Return (Local0)
                }
            }
        ...
        Device (BAT2)
        {
            ...
            Method (_BST, 0, NotSerialized)
            {
                ...
                If (\_SB.ECOK)
                {
                    ...
                    Store (\_SB.PCI0.LPCB.EC0.ACDF, Local6)
                    Store (\_SB.PCI0.LPCB.EC0.Z003, AUXB)
                    Release (\_SB.PCI0.LPCB.EC0.MUT1)
                    If (Local6)
                    {
                        If (LEqual (Local5, 0x01))
        ...
        Scope (\_SB)
        {
            Device (WMID)
            {
                ...
                Method (Z00Y, 1, NotSerialized)
                {
                    ...
                    If (LLessEqual (Local0, 0x01))
                    {
                        Store (\_SB.WMID.PHSR (0x0C, Local0), BUFF)
                    }
                    Else
                    {
                        Store (0x01, BUFF)
