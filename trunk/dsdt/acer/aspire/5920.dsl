 ...
 *
 * Disassembly of 5920, Fri Aug  3 17:32:57 2007
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008F96 (36758)
 *     Revision         0x02
 *     OEM ID           "INTEL "
 ...
 */
DefinitionBlock ("5920.aml", "DSDT", 2, "INTEL ", "CRESTLNE", 0x06040000)
{
    External (PDC1)
    External (PDC0)
    External (CFGD)
    ...
    Method (_PTS, 1, NotSerialized)
    {
        ...
        If (\_SB.ECOK)
        {
            ...
            If (LEqual (\_SB.PCI0.RP06.LANE.LANP, 0x00))
            {
    ...
    Scope (\_SB)
    {
        ...
        OperationRegion (SMI1, SystemMemory, 0x7FEE0E2D, 0x00000120)
