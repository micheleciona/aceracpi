 ...
 *
 * Disassembly of 1000, Sun Dec 16 12:48:40 2007
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00007502 (29954)
 *     Revision         0x01
 *     OEM ID           "ATI"
 *     OEM Table ID     "SB460"
 ...
 */
DefinitionBlock ("1000.aml", "DSDT", 1, "ATI", "SB460", 0x06040000)
{
    External (Z00H)
    ...
    OperationRegion (\D80H, SystemIO, 0x80, 0x01)
    Field (\D80H, ByteAcc, NoLock, Preserve)
    {
        P80H,   8
    }
    ...
    Scope (\_SB)
    {
        Name (LINX, 0x00)
        Name (OSTB, Ones)
        OperationRegion (OSTY, SystemMemory, 0x8FE95DE4, 0x00000001)
    ...
    Scope (\_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            OperationRegion (K8ST, SystemMemory, 0x8FE95F74, 0x00000048)
            ...
            Device (PB5)
            {
                ...
                Scope (\_SB.PCI0)
                {
                    Device (DOCK)
                    {
                        ...
                        Method (_DCK, 1, NotSerialized)
                        {
                            If (LEqual (Arg0, 0x01))
                            {
                                Store (0x00, \_SB.PCI0.PB5.LDIS)
                            }
                            Else
                            {
                                Store (0x01, \_SB.PCI0.PB5.LDIS)
                            }
                        ...
                        {
                            If (LEqual (\_SB.PCI0.PB5.LDIS, 0x01))
                            {
                                Return (0x00)
                            }
                            Else
                ...
                Device (PXHA)
                {
                    ...
                    Method (_INI, 0, NotSerialized)
                    {
                        If (LEqual (\_SB.PCI0.PB5.LDIS, 0x00))
                        {
                            If (LEqual (\_SB.PCI0.PB5.PRSB, 0x01))
                            {
            ...
            Device (LPC0)
            {
                ...
                OperationRegion (SMI1, SystemMemory, 0x8FE95DE5, 0x00000120)
