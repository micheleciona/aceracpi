 ...
 *
 * Disassembly of 42200, Sat Dec 20 08:34:41 2008
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000462F (17967)
 ...
 */
DefinitionBlock ("42200.aml", "DSDT", 1, "INTEL ", "ODEM    ", 0x06040000)
{
    ...
    OperationRegion (MNVS, SystemMemory, 0x1FF7BE7D, 0x40)
        ...
        ThermalZone (THRC)
        {
            Method (_TMP, 0, NotSerialized)
            {
                If (\ECON)
                {
                    ...
                    Store (\_SB.PCI0.LPCB.EC0.RAMR (0xD5, 0x05), Local2)
                }
                Else
                {
                    PHSR (0x19, 0x00)
                ...
                If (LGreaterEqual (Local0, T5SD))
                {
                    If (LGreaterEqual (T5CT, 0x03))
                    {
                        Store (Local0, P80H)
            ...
            {
                Return (Add (Multiply (T5SD, 0x0A), TBSE))
            }
        ...
        ThermalZone (THRS)
        {
            Method (_TMP, 0, NotSerialized)
            {
                If (\ECON)
                {
                    ...
                    Store (\_SB.PCI0.LPCB.EC0.RAMR (0xD9, 0x05), Local2)
                }
                Else
                {
                    PHSR (0x18, 0x00)
                ...
                If (LGreaterEqual (Local0, T52V))
                {
                    If (LGreaterEqual (T52V, 0x03))
                    {
                        Store (Local0, P80H)
                        Return (Add (Multiply (Local0, 0x0A), TBSE))
                    }
            ...
            Method (_CRT, 0, NotSerialized)
            {
                Return (Add (Multiply (T52V, 0x0A), TBSE))
            }
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Device (LPT)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)
                    {
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.LPT._Y1E._MIN, MINA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.LPT._Y1E._MAX, MAXA)
                        CreateWordField (CRSA, \_SB.PCI0.LPCB.LPT._Y1F._INT, INTA)
                        CreateByteField (CRSA, \_SB.PCI0.LPCB.LPT._Y1E._LEN, LENA)
                        Store (Zero, MINA)
                        Store (Zero, MAXA)
                        Store (Zero, INTA)
                        Store (Zero, LENA)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y20._MIN, MINB)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y20._MAX, MAXB)
                        CreateByteField (CRSB, \_SB.PCI0.LPCB.LPT._Y20._LEN, LENB)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y21._MIN, MINC)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y21._MAX, MAXC)
                        CreateByteField (CRSB, \_SB.PCI0.LPCB.LPT._Y21._LEN, LENC)
                        CreateWordField (CRSB, \_SB.PCI0.LPCB.LPT._Y22._INT, INTB)
                        CreateByteField (CRSB, \_SB.PCI0.LPCB.LPT._Y23._DMA, DMAB)
                        Store (Zero, MINB)
                        Store (Zero, MAXB)
                        Store (Zero, LENB)
                        Store (Zero, MINC)
